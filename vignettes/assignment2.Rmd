...
read_csv("../inst/extdata/AUdeaths_corrected_10-11-2016.csv") %>%
  ...
  kable(align = "llr", caption = "Table 2 - Suicide Total Deaths", format.args = list(big.mark = ","))
```
